...
func initialize_population():
	...
	for i in POPULATION_SIZE:
		...
		for j in CHROMOSOME_LENGTH:
			chromosome.append(GENERIC_TERRAINS[rng.randi_range(0, GENERIC_TERRAINS.size() - 1)])
...
func insert_unique_terrain(chromosome: Array) -> Array:
	...
	new_chromosome[idx] = SET_PIECES[rng.randi_range(0, SET_PIECES.size() - 1)]
